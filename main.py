...
class VanInvoice(QWidget):
    ...
    def reprintBut(self):  
        ...
        try:
            ...
            cur = conn.cursor()
            df2 = pd.read_excel("Data/pr_sysky.xlsx", sheet_name="pr_sysky")
            ...
            if ftype == 'INV':
                # load excel file
                df = pd.read_excel("Data/pri_hd.xlsx", sheet_name="pri_hd")            
                df.to_sql(name='pri_hd', con=conn, if_exists='append')
                df1 = pd.read_excel("Data/pri_det.xlsx", sheet_name="pri_det")
                ...
                df1 = pd.read_excel("Data/prq_det.xlsx", sheet_name="prq_det")
                ...
                df = pd.read_excel("Data/prw_hd.xlsx", sheet_name="prw_hd")           
                df.to_sql(name='prw_hd', con=conn, if_exists='append')
                df1 = pd.read_excel("Data/prw_det.xlsx", sheet_name="prw_det")
            ...
            save_name = os.path.join("inv_pdf/", finame+'.pdf')           
    ...
    def getData(self):
        try:
            ...
            #get ship details
            cur.execute("SELECT ONAME||COALESCE(OFNAME,' '),OADDR1, OADDR2,OADDR3,OPCODE,OBPHONE,OPSTNO,OSTREET,OINAME,OIADDR1,OIADDR2,OIADDR3,OIPCODE FROM pri_hd WHERE  PR_STATUS is null")
            shipping = cur.fetchall()
    ...
    def toPDF(self):
        ...
        try:
            ...
            try:               
               ...
               df.to_excel('Data/pri_hd.xlsx',sheet_name = 'pri_hd', index=False)
